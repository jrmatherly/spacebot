...
> - **Phase 11.2 PR #136 is OPEN as draft (in-flight).** Tasks 1-15 of the per-store dispatch plan are committed on `feat/phase-11-pr-2-instance-postgres` (HEAD `f0d7693` as of 2026-04-26 evening). Phase 11.3 / 11.4 still pending. Per-PR plans get written when the predecessor merges (per the writing-plans discipline).
