// Wiki visibility-chip + filter-wiring test.
...
describe("Wiki with visibility", () => {
	beforeEach(() => {
		...
		// Per-URL mock: /api/teams for the Share modal, /api/wiki
	...
	it("renders no chip for a page with null visibility (no-auto-broadening)", async () => {
		// No-auto-broadening policy: an unowned wiki page must show no
		// chip rather than defaulting to a Personal label. Pairs with
		// the backend invariant in
