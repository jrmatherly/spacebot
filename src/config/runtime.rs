...
pub struct RuntimeConfig {
    ...
    /// Change-driven knowledge synthesis (Layer 5). Replaces the bulletin's
    /// role as the knowledge injection mechanism. Narrower scope than the
    /// bulletin — no identity, events, or user profiles.
    pub knowledge_synthesis: ArcSwap<String>,
    /// Monotonically increasing counter, bumped on memory content changes
    /// (create, update, delete, merge). NOT bumped on importance-only changes.
    pub knowledge_synthesis_version: Arc<std::sync::atomic::AtomicU64>,
    /// The version at which knowledge synthesis was last regenerated.
    pub knowledge_synthesis_last_version: Arc<std::sync::atomic::AtomicU64>,
    /// Timestamp of the last knowledge_synthesis_version bump, for debouncing.
    pub knowledge_synthesis_last_change: Arc<std::sync::atomic::AtomicI64>,
...
impl RuntimeConfig {
    ...
    pub fn new(
        ...
        Self {
            ...
            knowledge_synthesis: ArcSwap::from_pointee(String::new()),
            knowledge_synthesis_version: Arc::new(std::sync::atomic::AtomicU64::new(0)),
            knowledge_synthesis_last_version: Arc::new(std::sync::atomic::AtomicU64::new(0)),
            knowledge_synthesis_last_change: Arc::new(std::sync::atomic::AtomicI64::new(0)),
    ...
    /// Signal that memory content changed (create, update, delete, merge).
