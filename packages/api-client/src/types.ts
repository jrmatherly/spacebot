...
/// Enriched portal-conversation list row. Intersection of
/// `PortalConversationSummary` with `VisibilityTag` fields
/// (`visibility`, `team_name`), generated by utoipa from the Rust
/// `PortalConversationListItem` wrapper. Mirrors `MemoryItem`,
/// `TaskItem`, `WikiListItem`, and `CronListItem`.
export type PortalConversationListItem =
	components["schemas"]["PortalConversationListItem"];
...
/// Enriched memory row returned by list endpoints. Intersection of the
/// `Memory` domain type with `VisibilityTag` fields (`visibility`,
/// `team_name`), generated by utoipa from the Rust `MemoryListItem` alias.
export type MemoryItem = components["schemas"]["MemoryListItem"];
...
/// Enriched cron-list row. Intersection of `CronJobWithStats` with the
/// `VisibilityTag` fields (`visibility`, `team_name`), generated by
/// utoipa from the Rust `CronListItem` wrapper. Mirrors `MemoryItem`,
/// `TaskItem`, and `WikiListItem`.
export type CronListItem = components["schemas"]["CronListItem"];
...
/// Enriched wiki-list row. Intersection of `WikiPageSummary` with the
/// `VisibilityTag` fields (`visibility`, `team_name`), generated by
/// utoipa from the Rust `WikiListItem` wrapper. Mirrors `MemoryItem`
/// and `TaskItem`.
...
/// Enriched task row returned by list endpoints. Intersection of the
/// `Task` domain type with `VisibilityTag` fields (`visibility`,
/// `team_name`), generated by utoipa from the Rust `TaskListItem` alias.
/// Matches the `MemoryItem` precedent.
export type TaskItem = components["schemas"]["TaskListItem"];
...
/// Enriched project row returned by the list endpoint. Intersection of the
/// `Project` domain type with `VisibilityTag` fields (`visibility`,
/// `team_name`), generated by utoipa from the Rust `ProjectListItem`
/// wrapper. Mirrors `MemoryItem` / `TaskItem` / `WikiListItem` /
